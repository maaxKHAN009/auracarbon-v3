...
import { Mail, Check, AlertCircle, Loader, ArrowLeft } from 'lucide-react';
    ...
    return (
      <div className="w-full max-w-md mx-auto p-8 rounded-xl bg-gradient-to-br from-[#0a0a1a] to-[#1a0a2e] border border-[#00FF88]/30 text-center">
        ...
        <p className="text-white/60 mb-6">
          We've sent a password reset link to <span className="text-[#00CCFF] font-medium">{email}</span>
        </p>
        <p className="text-white/40 text-sm">
          The link will expire in 1 hour. Redirecting to login...
        </p>
        <div className="w-full bg-[#00FF88]/20 rounded-full h-1 overflow-hidden mt-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-lg text-white placeholder:text-white/30 focus:outline-none focus:border-[#00CCFF]/50 focus:ring-1 focus:ring-[#00CCFF]/30 transition-all"
          />
        </div>
